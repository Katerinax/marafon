...
$subject ="Новая заявка с сайта marafon-sport.io";
...
$header .= "From: Новая заявка <katerinkabuva@gmail.com>\n\n";	
$mail = mail("katerinkabuva@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
